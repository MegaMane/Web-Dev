...
N'{
    ...
    "data": {
        ...
        "platforms": {
            ...
            "4947": {
                ...
                "sound": "4 × 8-bit PCM channels (2 stereo channels)",
                "maxcontrollers": "2",
                "display": "320×256",
            ...
            "4916": {
                ...
                "youtube": "http://www.youtube.com/watch?feature=player_embedded&v=g5SzWc8-X0M#!"
            },
            "4969": {
                "id": 4969,
                "name": "APF MP-1000",
            ...
            "4920": {
                ...
                "developer": "Microsoft",
                "manufacturer": "Microsoft",
                "media": "Blu-Ray Disc, 500 GB Hard Disk",
            ...
            "4912": {
                ...
                "sound": null,
                "maxcontrollers": "1",
                "display": "800 × 240 px (effectively 400 × 240 WQVGA per eye)",
            ...
            "4918": {
                ...
                "sound": "16-bit Stereo",
                "maxcontrollers": "1",
                "display": "84 x 224 pixel resolution (produced by scanning a 1 × 224 LED array)",
            ...
            "4979": {
                ...
                "media": "Floppy Diskette (Double Density)",
            ...
            "4913": {
                ...
                "graphics": "Text: 32 columns × 24 rows - 15 Shades | Image: 256×192 15 Shades",
                "sound": "1 Channel In-Built Beeper",
                "maxcontrollers": "Built In Rubber Keyboard / 1 Joystick Using Expansion Hardware",
            ...
            "4980": {
                ...
                "cpu": "Zen 2",
                "memory": "Unconfirmed",
                "graphics": "AMD Navi GPU",
                "sound": null,
                "maxcontrollers": null,
                "display": null,
                "overview": "The Playstation 5 is the successor to Sony&#039;s Playstation 4 console. Following the PlayStation 4 the PS5 be the second in the Sony series to feature compatibility with the x86 architecture.\r\nExpected Launch Q4 2020",
                "youtube": "E429XW4isFs"
            },
            "13": {
                "id": 13,
    ...
    "remaining_monthly_allowance": 2995,
    "extra_allowance": 0,
    "allowance_refresh_timer": 2573952
}';
...
SELECT --B.[key],
	   ...
	   C.cpu as CPU,
	   C.memory as Memory,
       C.graphics as Graphics,
	   C.sound as Sound,
	   C.maxcontrollers as MaxControllers,
	   C.display as Display,
	   C.overview as Overview
INTO #Platforms
FROM OPENJSON(@json, '$.data') WITH([count]  INT
                         ,[platforms]    NVARCHAR(MAX) AS JSON) A
OUTER APPLY OPENJSON(A.[platforms]) B 
...
--https://www.nuomiphp.com/eplan/en/652.html
 ...
 Select TMP.PlatformId,
		...
		TMP.Display,
		TMP.Overview
From #Platforms as TMP
Left Join Platforms as P
on TMP.PlatformId = P.PlatformId
